...
print(libsmctrl.libsmctrl_set_stream_mask_lzc)  
...
def test_lzc_mask(torch_stream, mask_list):
    stream_ptr = ctypes.c_void_p(torch_stream.cuda_stream)
    libsmctrl.libsmctrl_set_stream_mask_lzc(stream_ptr, mask_list[0], mask_list[1], mask_list[2], mask_list[3])

high = generate_mask(10, 0)
low = generate_mask(10, 2)
high = 0x0000bbbbbbbbffff
print(hex(high))
print(hex(low))
list = [0xfff, 0xfff, 0x000, 0x00b]
stream = torch.cuda.Stream("cuda")
test_lzc_mask(stream, list)